...
extension Main {
    ...
    static func detailItems(sideBarTabSelected: SideBar.ListFilterOptions, sideBarItemIdsSelected: Set<UUID>, all: Array<Item>, waiting: Array<Item>, done: Array<Item>) -> Array<Item> {
